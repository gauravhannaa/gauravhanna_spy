// Setup (admin only – ideally protect with a key)
router.post('/setup', async (req, res) => {
  ...
  // Also store hashed version for comparison? But we already compare with plaintext. Better to store hash in DB.
  // For production, store the hash in a DB and read from there.
